      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-3 flex justify-center items-center">
            {/* Double glass ring container representing Petri Dish */}
            <div className="relative p-2 sm:p-3 rounded-full border border-gray-200 bg-white shadow-sm flex items-center justify-center select-none">
              <div className="p-1 sm:p-1.5 rounded-full border border-gray-150 bg-gray-50/50">
                <img 
                  src="/science-gel.png" 
