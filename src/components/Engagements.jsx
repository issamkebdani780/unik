    ...
    <div className="w-full bg-[#fcfcfc] py-8 sm:py-16 animate-[fadeDown_0.3s_ease]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center mb-20 sm:mb-32">
          {/* Left Image */}
          <div className="lg:col-span-6 h-[320px] sm:h-[450px] bg-brand-light transition-colors duration-500 overflow-hidden border border-gray-100 flex items-center justify-center relative order-2 lg:order-1">
            <img
          ...
          <div className="lg:col-span-6 space-y-6 order-1 lg:order-2">
            <span className="text-[10px] sm:text-xs font-bold tracking-[0.2em] text-brand-accent transition-colors duration-500 uppercase block mb-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center text-center">
            {[
              ...
              <div key={i} className="space-y-2 px-4">
                <div className="mb-3 flex justify-center text-brand-accent">{cert.icon}</div>
        ...
        {/* CTA Block */}
        <div className="bg-brand-light text-center p-8 sm:p-14 relative overflow-hidden flex flex-col items-center transition-colors duration-500">
          <div className="relative z-10 max-w-xl space-y-5">
            ...
            <Link
              to="/catalog"
              className="inline-block bg-brand-accent text-white px-8 py-4 text-xs font-bold tracking-widest hover:bg-black transition-colors uppercase duration-300 rounded-none shadow-sm cursor-pointer"
            >
