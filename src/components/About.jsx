  ...
  return (
    <div className="w-full bg-[#fcfcfc] py-8 sm:py-16 animate-[fadeDown_0.3s_ease]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Expanded Engagements Section (Moved from Engagements.jsx) */}
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-24 pt-10 border-t border-gray-200/60">
          <span className="text-[10px] sm:text-xs font-bold tracking-[0.25em] text-gray-400 uppercase block mb-3">
            NOTRE CHARTE DE CONFIANCE
          </span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-black uppercase tracking-tight mb-6 leading-none">
            NOS ENGAGEMENTS
          </h2>
          <p className="text-gray-500 font-medium text-sm sm:text-base leading-relaxed">
