// Local file mapping for lifestyle images based on visual relevance:
const DERMATO_LIFESTYLE_IMAGE = '/about_lab.png'; // Appropriate for dermato lab setting
const CAPILLAIRE_LIFESTYLE_IMAGE = '/capillaire_serum.png'; // Appropriate for capillaire hands-on shot
...
export const products = [
  {
    ...
    // FIX: Replaced Unsplash link with local image path
    ugcVideo: CAPILLAIRE_LIFESTYLE_IMAGE, 
    routine: {
  ...
  },
  {
    ...
    education: {
      whyChosen: "L'Huile d'Argan est riche en vitamine E et en acides gras essentiels, parfaits pour sceller l'hydratation. Les Protéines de Blé hydrolysées sont de petites molécules capazes de pénétrer sous les écailles du cheveu pour le réparer de l'intérieur.",
  ...
  },
  {
    ...
    // FIX: Replaced Unsplash link with local image path
    ugcVideo: DERMATO_LIFESTYLE_IMAGE,
    routine: {
    ...
    ingredients: 'Aqua, Glycerin, Cocamidopropyl Betaine, Sodium Lauroyl Methyl Isethionate, Salicylic Acid, Zinc PCA, Camellia Sinensis Leaf Extract, Allantoin, Panthenol, Sodium Hydroxide, Sodium Chloride, Sodium Benzoate, Citric Acid.',
    sizes: ['150ml', '300ml'],
  ...
  },
  {
    ...
    education: {
      ...
      howItWorks: "Les antioxydants donnent des électrons aux radicaux libres (pollution, UV) avant qu'ils n'attaquent vos cellules. En parallèle, la Vitamine C blocks la tyrosinase, l'enzyme responsable de la production de mélanine, réduisant ainsi les taches.",
